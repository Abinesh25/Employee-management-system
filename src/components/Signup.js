  ...
  return (
    <div className='signpage'>
        ...
        <form onSubmit={handlesignup}>
            ...
            <input type='text' className='user' value={username} onChange={(e)=>{
                setUsername(e.target.value)}}/><br></br><br></br>
            <label>Email:</label>
            <input type='email' className='mail' value={email} onChange={(e)=>{
                setEmail(e.target.value)}}/><br></br><br></br>
            <label>password:</label>
            <input type='password' className='pass' value={password} onChange={(e)=>{
